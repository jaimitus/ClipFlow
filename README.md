...
- **🛡️ 100% Private & Zero Telemetry:** No user account, no login, no cloud upload, no telemetry sockets, and no background updater service.
...
- **Standalone Portable:** `ClipFlow_v1.0.0_Portable.exe` (Single executable, no installation needed)
- **Setup Installer:** `ClipFlow_1.0.0_x64-setup.exe` (NSIS Installer)
- **MSI Package:** `ClipFlow_1.0.0_x64_en-US.msi` (Windows Installer)
...
Saved clips are stored in `%USERPROFILE%\Videos\ClipFlow`.
